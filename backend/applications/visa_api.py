...
class VisaResource(Resource, CommonBookingResource):
    ...
    def _format_visa(self, visa):
        return {
            ...
            'passenger_first_name': visa.passenger.first_name if visa.passenger else None,
            'passenger_middle_name': visa.passenger.middle_name if visa.passenger else None,
            'passenger_last_name': visa.passenger.last_name if visa.passenger else None,
    ...
    def _format_for_export(self, visa):
        data = {
            ...
            'Passenger First Name': visa.passenger.first_name if visa.passenger else '',
            'Passenger Middle Name': visa.passenger.middle_name if visa.passenger else '',
            'Passenger Last Name': visa.passenger.last_name if visa.passenger else '',
